...
// At 15bb, strategy is primarily push-or-fold (allin or fold)
// 'r' here means all-in shove

export const DB_TOURN_15BB: GtoDB = {
  // ── UTG shove ─────────────────────────────────────────────────────────────
  'tournament_9max_15bb_UTG_open': makeRange(
  ...
  // ── HJ shove ──────────────────────────────────────────────────────────────
  'tournament_9max_15bb_HJ_open': makeRange(
  ...
  // ── CO shove ──────────────────────────────────────────────────────────────
  'tournament_9max_15bb_CO_open': makeRange(
    ...
    [],
    { '44':'mr:60','33':'mr:40','22':'mr:30' }
  ),

  // ── BTN shove ─────────────────────────────────────────────────────────────
  'tournament_9max_15bb_BTN_open': makeRange(
  ...
  // ── SB shove ──────────────────────────────────────────────────────────────
  'tournament_9max_15bb_SB_open': makeRange(
    ['AA','KK','QQ','JJ','TT','99','88','77',
     'AKs','AQs','AJs','ATs','A9s','A8s','A7s','A5s',
     'AKo','AQo','AJo','ATo','A9o',
     'KQs','KJs','KTs','KQo','KJo',
  ...
  // ── BB vs shove (call range, tighter) ─────────────────────────────────────
  'tournament_9max_15bb_BB_vs_open': makeRangeDefaultCall(
    ['AA','KK','QQ','JJ','TT','99',
     'AKs','AQs','AJs','AKo','AQo',
     'KQs'],
