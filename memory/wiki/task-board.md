...
- [ ] **T-096** | Pipeline | **Extract 舊 DB 資料搬進 `gto_solutions`** `(2026-04-23 派工，T-095 Done 後可接；可與 T-097 並行)`
...
- [ ] **T-097** | Pipeline | **`seed-batches.mjs` + `batch-worker.mjs` + `gto_batch_progress` 升級 對齊 Schema v2** `(2026-04-23 派工，T-095 Done 後可接；可與 T-096 並行，不同 session)`
